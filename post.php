...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <hr>
            <img class="img-responsive" src="images/<?php echo ($post_image); ?>" alt="404 not found">
            <hr>
            <p>
            ...
            if (isset($_POST['create_comment'])) {
                ...
                $query .= "VALUES ('{$the_post_id}','{$post_author}','{$comment_email}','{$comment_content}','unapproved',now())";
